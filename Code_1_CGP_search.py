...
parser.add_argument('--target', type=int, default=64, choices=[36, 40, 42, 44, 46, 48, 52, 56, 60, 64])
...
parser.add_argument('--mutate-rate', type=float, default=0.1, choices=[0.01, 0.025, 0.05, 0.10, 0.15, 0.20])
